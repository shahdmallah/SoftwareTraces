      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.packageHeader}>
          <Text style={[styles.packageTitle, isArabic ? rtlText : ltrText]}>
            {isArabic ? 'حزمة الأمان دون اتصال' : 'Offline Package Includes'}
          </Text>
          <View style={styles.packageList}>
            <Text style={[styles.packageItem, isArabic ? rtlText : ltrText]}>✓ {isArabic ? 'مسار التريل' : 'Trail geometry'}</Text>
            <Text style={[styles.packageItem, isArabic ? rtlText : ltrText]}>✓ {isArabic ? 'الملف الشخصي للارتفاع' : 'Elevation profile'}</Text>
            <Text style={[styles.packageItem, isArabic ? rtlText : ltrText]}>✓ {isArabic ? 'نقاط التحقق من الأمان' : 'Safety checkpoints'}</Text>
            <Text style={[styles.packageItem, isArabic ? rtlText : ltrText]}>✓ {isArabic ? 'مناطق الخطر المجاورة' : 'Danger zones nearby'}</Text>
          ...
          <Text style={[styles.packageNote, isArabic ? rtlText : ltrText]}>
            {isArabic ? 'تعرض هذه الصفحة الحزم المحفوظة محليًا لتخزين المسار وسلامة المشي في الأماكن ذات التغطية الضعيفة.' : 'Saved trail and safety data stay available when your signal fades.'}
          </Text>
        </View>

        <View style={styles.sectionHeader}>
          <Text style={[styles.sectionTitle, isArabic ? rtlText : ltrText]}>{isArabic ? 'على هذا الجهاز' : 'On this device'}</Text>
        </View>
