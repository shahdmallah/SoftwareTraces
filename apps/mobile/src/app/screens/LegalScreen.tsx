...
type LegalNavigationProp = StackNavigationProp<RootStackParamList, 'Legal'>;
  ...
  return (
    <AnimatedScreen style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.subtitle}>Terms of service and privacy details can be displayed here.</Text>
      </View>
    </AnimatedScreen>
  );
}
