...
type SupportHelpNavigationProp = StackNavigationProp<RootStackParamList, 'SupportHelp'>;

export function SupportHelpScreen() {
  const navigation = useNavigation<SupportHelpNavigationProp>();
  ...
  return (
    <AnimatedScreen style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.subtitle}>Help center links and FAQs can be shown here.</Text>
      </View>
    </AnimatedScreen>
  );
}
