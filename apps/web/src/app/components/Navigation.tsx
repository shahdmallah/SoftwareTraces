...
import { Map, Compass, Bookmark, Activity, User, Plus, LogOut } from 'lucide-react';
...
export function DesktopNavigation({ onSignOut }: DesktopNavigationProps) {
  ...
  return (
    <nav className="hidden md:flex items-center justify-between h-16 px-6 bg-card border-b border-border sticky top-0 z-50">
      <Link to="/" className="flex items-center gap-2">
        ...
        <span className="text-sm text-muted-foreground">تريسز</span>
      </Link>
